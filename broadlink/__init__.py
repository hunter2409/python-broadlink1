...
def gendevice(devtype, host, mac):
  ...
  if devtype == 0x2720: # SPMini
    ...
    return sp2(host=host, mac=mac)
  elif devtype == 0x947C: # SPMiniPlus2
    return sp2(host=host, mac=mac)
  elif devtype == 0x7547: # SC1 WiFi Box
    return sp2(host=host, mac=mac)
  elif devtype == 0x2710: # RM1
    return rm(host=host, mac=mac)
  elif devtype == 0x2712: # RM2
    return rm(host=host, mac=mac)
  elif devtype == 0x2737: # RM Mini
    return rm(host=host, mac=mac)
  elif devtype == 0x27A2: # RM Mini R2
    return rm(host=host, mac=mac)
    ...
    return rm(host=host, mac=mac)
  elif devtype == 0x2714 or devtype == 0x27A3: # A1
